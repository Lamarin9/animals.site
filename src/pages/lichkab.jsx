                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-sm-9">
                                                <div className="d-flex justify-content-between">
                                                    ...
                                                    <button type="button" className="btn btn-primary izmena8" data-bs-toggle="modal" data-bs-target="#exampleModal3">
                                                        Изменить данные
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-sm-9">
                                                <div className="d-flex justify-content-between">
                                                    ...
                                                    <button type="button" className="btn btn-primary izmena8" data-bs-toggle="modal" data-bs-target="#exampleModal2">
                                                        Изменить данные
                                                    </button>
                                                </div>
                                            </div>
